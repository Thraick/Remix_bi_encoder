...
export const action: ActionFunction = async ({ request, params }) => {
  ...
  try {
    ...
    let selectintent = response.filter((item:any)=>(item.anchor === id))
    return json({"data": selectintent});
...
//   const [list, setlist] = useState(data.statements)
//   const [intent, setIntent] = useState(data.anchor)
...
//     let values = {
//       anchor: data.anchor,
//       statements: [newUtteranceChange, ...list],
//       id: data.jid
//     }
//     setlist(values.statements)
